...
class TextInputProcessor:
    ...
    def getPreprocessTheArrayTexts(self,inputArray):
        Processed_Text=[" ".join(self.getPreprocessedInput(sentence)) for sentence in inputArray]
        print(Processed_Text)
...
class TextSentimentAnalyser:
    ...
    def predictFormArray(self,inputVector):
        return self.model.predict(inputVector)  
